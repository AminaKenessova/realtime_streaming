            ...
            messages=[
                {
                    "role": "system",
                    "content": """
                        This is a machine learning model with a task of classifying comments into POSITIVE, NEGATIVE, NEUTRAL.
...
def start_streaming(spark):
    ...
    while True:
        try:
            ...
            print(f'Exception encountered: {e}. Retry in 10 seconds')
            sleep(10)
